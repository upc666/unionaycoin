...
int64 nChainStartTime = 1517322547;
...
const string strMessageMagic = "unionaycoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in unionaycoin
    bool fStrictPayToScriptHash = true; // Always active in unionaycoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "unionaycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector unionaycoin empty mapBlockIndex unionaycoin unionaycoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 3938313 : 279540;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x3eb0b68bef69fb4ea3d97dc57bd4951c25a5f199d4a2676ae48454b3ceec37ae"));
...
unsigned char pchMessageStart[4] = { 0x31, 0x76, 0x77, 0x72 };
